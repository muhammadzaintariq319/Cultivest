...
class _RegistrationScreenState extends State<RegistrationScreen> {
  ...
  void _submitForm() async {
    // Form Validation check (Project Guideline: User Input Handling & Validation)
    if (_formKey.currentState!.validate()) {
      // Agar validation pass ho jaye toh aage ka process karein
      
      final authProvider = Provider.of<AuthProvider>(context, listen: false);
      
      // Check if email already exists
      bool emailExists = await authProvider.checkEmailExists(_emailController.text.trim(), 'farmer');
      if (emailExists) {
        if (!mounted) return;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // SafeArea aur SingleChildScrollView taake keyboard open hone par screen overflow na ho
      body: SafeArea(
              ...
              children: [
                ...
                Center(
                  child: GestureDetector(
                    onTap: () {
                      // Yahan Login screen par janay ka code
                      Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(builder: (context) => const FarmerLoginScreen()),
                      );
  ...
  // Reusable Widget for Labels (Good for Code Structure)
  ...
  // Reusable Widget for TextFields (Reduces Code Duplication)
  Widget _buildTextField({
    ...
    // Agar showVisibilityToggle true hai toh currentObscureState use karein,
    // warna isPassword ke hisaab se hide karein
